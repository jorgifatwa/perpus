                        ...
                        <form action="{{ route('pinjam.update',$pinjam->pinjam_id) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="hidden" name="status_update" value="Pinjam">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="inputEmail3" class="col-sm-2 col-form-label">Pinjam Date</label>
                                <div class="col-sm-10">
                                    <input type="date" class="form-control" name="pinjam_date" id="datetimepicker" value="{{ $pinjam->pinjam_date }}"/>
                                </div>
                            </div>
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    value="{{ $pinjam->quantity}}"
                                    >
                                    <input type="hidden" class="form-control" name="quantity_asal" id="quantity"
                                    value="{{ $pinjam->quantity}}"
                                    >
                                </div>
                            </div>
